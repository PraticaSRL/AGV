...
//Variabili globali
visualization_msgs::Marker line_strip_rtls, line_strip_real, line_strip_odom;
ros::Publisher marker_pub_rtls, marker_pub_real, marker_pub_odomf;
geometry_msgs::Point p;

geometry_msgs::TransformStamped t_rtls;
...
int main( int argc, char** argv )
{
	...
	try
	{
		t_rtls = tfBuffer.lookupTransform("map", "rtls", ros::Time(0), ros::Duration(10.0) );
	}
